...
default = """`aq calc x`: reduce x and return one random equivalent

`aq calcs x`: reduce x and return up to 30 random equivalents

`aq lookup x`: x must be a whole number. return up to 30 equivalents for x
